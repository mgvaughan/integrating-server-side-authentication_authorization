...
usersRouter.get('/:id', passport.authenticate('jwt', {session: false}), async (req, res) => {
...
usersRouter.put('/:id', passport.authenticate('jwt', {session: false}), async (req, res) => {
...
usersRouter.post('/', passport.authenticate('jwt', {session: false}), async (req, res) => {
