...
chirpsRouter.get('/:id', passport.authenticate('jwt', {session: false}), async (req, res) => {
...
chirpsRouter.put('/:id', passport.authenticate('jwt', {session: false}), async (req, res) => {
    let id = Number(req.params.id)
...
chirpsRouter.post('/', passport.authenticate('jwt', {session: false}), async (req, res) => {
...
chirpsRouter.delete('/:id', passport.authenticate('jwt', {session: false}), async (req, res) => {
    let id = Number(req.params.id)
    try {
